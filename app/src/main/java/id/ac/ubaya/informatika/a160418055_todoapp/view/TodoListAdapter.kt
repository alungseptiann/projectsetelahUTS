...
import id.ac.ubaya.informatika.a160418055_todoapp.databinding.TodoItemLayoutBinding
...
class TodoListAdapter(val todoList:ArrayList<Todo>, val adapterOnClick:(Any) -> Unit):RecyclerView.Adapter<TodoListAdapter.TodoListViewHolder>()
    ...
    override fun onBindViewHolder(holder: TodoListViewHolder, position: Int) {
        ...
        /*holder.view.checkTask.text = todoList[position].title.toString()
//        + " " + todoList[position].priority
